  ...
  return (
    <div className="relative min-h-screen bg-white">
      ...
      <main className="relative z-10">
        {/* 1. Hero — full viewport; WebGL shader is the only background layer */}
        <section className="landing-hero-viewport relative flex flex-col overflow-x-hidden px-4 sm:px-6 lg:px-8 py-2 sm:py-3 md:py-3">
          <ShaderAnimation className="z-0" canvasOpacity={1} />
          <div className="landing-hero-content relative z-10 flex h-full min-h-0 w-full max-w-screen-2xl flex-1 flex-col mx-auto md:overflow-hidden">
            <motion.div
            ...
            >
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-[2.5rem] xl:text-[2.75rem] font-bold tracking-tight text-white mb-1.5 sm:mb-2 md:mb-2 leading-tight [text-shadow:0_1px_2px_rgba(0,0,0,0.45),0_4px_28px_rgba(0,0,0,0.35)]">
                Run your business
                <span className="block mt-0.5 bg-gradient-to-r from-emerald-300 via-emerald-200 to-teal-200 bg-clip-text text-transparent [filter:drop-shadow(0_1px_3px_rgba(0,0,0,0.55))]">
                  smarter, not harder
                </span>
              </h1>
              <p className="text-sm sm:text-base md:text-lg text-emerald-50/95 mb-3 sm:mb-3.5 md:mb-4 max-w-3xl xl:max-w-4xl mx-auto leading-snug md:leading-relaxed [text-shadow:0_1px_3px_rgba(0,0,0,0.5)]">
              ...
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 justify-center">
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2 px-5 py-2.5 md:px-6 md:py-2.5 rounded-xl bg-gradient-to-r from-emerald-600 to-emerald-700 text-white font-semibold text-sm md:text-base shadow-[0_4px_24px_-4px_rgba(5,150,105,0.55),0_2px_8px_rgba(0,0,0,0.25)] hover:from-emerald-700 hover:to-emerald-800 transition-all"
                >
                ...
                <a
                  href="#demo"
                  className="inline-flex items-center justify-center gap-2 px-5 py-2.5 md:px-6 md:py-2.5 rounded-xl border-2 border-white/40 bg-white/5 text-white font-semibold text-sm md:text-base backdrop-blur-sm hover:border-white/60 hover:bg-white/10 transition-colors [text-shadow:0_1px_2px_rgba(0,0,0,0.35)]"
                >
            ...
            <motion.div
              ...
              className="landing-hero-diagram mt-0 md:-mt-1 flex min-h-0 min-w-0 flex-1 flex-col w-full pointer-events-auto landing-cpu-slot"
            >
